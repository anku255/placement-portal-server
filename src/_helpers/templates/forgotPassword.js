exports.forgotPasswordTemplate = (hostUrl, email, name, token) => `
<!DOCTYPE html>
<html lang="en">
  <head>
                    ...
                    <td align="left" valign="top">
                      ...
                      >
                        <span
                          style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #000000; font-size: 20px; line-height: 28px;"
                        >
                          We received a request to reset your password. If this is correct, please confirm by
